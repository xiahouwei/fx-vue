...
import { EMPTY_OBJ } from "@fx-vue/shared";
...
export function createComponentInstance(vnode, parent) {
	...
	const instance = {
		...
		render: null,
		proxy: null,
		provides: parent ? parent.provides : Object.create(appContext.provides), //  获取 parent 的 provides 作为当前组件的初始化值 这样就可以继承 parent.provides 的属性了
